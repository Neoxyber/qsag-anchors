...
`qsag-anchors` is one of ten sibling artefacts in the Q-SAG open-source substrate programme. The full list, in shipping order per the amended ADR-0031 §2.2:
